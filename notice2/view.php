<? 
	...
	$image_name[0]   = $row[file_name_0]; //파일의 실명
	$image_name[1]   = $row[file_name_1];
	$image_name[2]   = $row[file_name_2];


	$image_copied[0] = $row[file_copied_0];	// 2022_02_22_10_43_01_0.jpg 파일의 임시 이름
	...
	<div class="visual">
        ...
        <div class="sub_nav">
            <ul>
                ...
                <li><a class="current" href="../notice2/list.php">이벤트</a></li>
