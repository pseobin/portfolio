<? 
	...
	$table = "notice2";	// sql문에서 table명을 변수로 처리
?>
<!DOCTYPE html>
<html lang="ko">
<head>
	...
	<div class="visual">
        ...
        <div class="sub_nav">
            <ul>
                ...
                <li><a  class="current" href="./list.php">이벤트</a></li>
							...
							<?		
								for ($i=$start; $i<$start+$scale && $i < $total_record; $i++)                    
								{
									...
									if($row[file_copied_0]){	// 첨부된 첫번째 이미지가 있으면 해당 이미지
										...
										$item_img = './data/default.png';	// 이미지가 없으면 default.jpg
									}
